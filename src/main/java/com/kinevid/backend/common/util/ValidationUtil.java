package com.kinevid.backend.common.util;
...
import com.kinevid.backend.common.exceptions.ValidationFieldException;
...
public class ValidationUtil {
    ...
    public static void throwExceptionIfRequiredLong(String name, Long value, boolean required) throws OperationException {
        if (required && value == null) {
            throw new OperationException(FormatUtil.requerido(name));
        }
    }
    ...
    public static void throwExceptionIfInvalidDate(String inicioDeCirugía, java.sql.Date dateTimeSurgeryStart) {
    }
}
